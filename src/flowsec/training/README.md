...
Teacher pilot/bulk annotation, final SFT corpus joining, and isolation audit.
...
Classification CE is applied only where `classification_supervision_valid` is
true. The original LM head remains frozen but supplies the Evidence-State LM
loss.
